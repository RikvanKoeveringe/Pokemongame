...
public enum PokemonData {
    ...
    VENUSAUR(100, PokemonType.GRASS, 30, 45),
    CHARMANDER(100, PokemonType.FIRE, 30, 15),
    CHARMELEON(100, PokemonType.FIRE, 30, 30),
    CHARIZARD(100, PokemonType.FIRE, 30, 45),
    SQUIRTLE(100, PokemonType.WATER, 30, 15),
    WARTORTLE(100, PokemonType.WATER, 30, 30),
    BLASTOISE(100, PokemonType.WATER, 30, 45),
